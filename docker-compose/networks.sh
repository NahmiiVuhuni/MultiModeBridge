docker network create --driver=bridge --subnet=172.19.40.0/24 --ip-range=172.19.40.0/24 --gateway 172.19.40.254 main
...
docker network create --driver=bridge --subnet=172.19.44.0/24 --ip-range=172.19.44.0/24 --gateway 172.19.44.254 m17
docker network create --driver=bridge --subnet=172.19.45.0/24 --ip-range=172.19.45.0/24 --gateway 172.19.45.254 dmr
